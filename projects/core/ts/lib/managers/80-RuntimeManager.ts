...
> {
	...
	>(
		ctx: Context<TEvents, TChannels, TStages, TGlobals, TModules, TTranslations, TApp>,
		app: TApp
	): RuntimeManager<TEvents, TChannels, TStages, TGlobals, TModules, TTranslations, TApp> {
		return new RuntimeManager<TEvents, TChannels, TStages, TGlobals, TModules, TTranslations, TApp>(ctx, app);
	}
